...
export const PhoneSchemaEn = Schema.Trim.pipe(
  Schema.nonEmptyString({ message: () => "Please provide your phone number so we can contact you; the phone number is a required field" }),
...
export const PhoneSchemaPl = Schema.Trim.pipe(
  Schema.nonEmptyString({ message: () => "Podaj swój numer telefonu, tak abyśmy mogli się z Tobą skontaktować; numer telefonu jest polem obowiązkowym" }),
