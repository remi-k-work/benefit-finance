...
export const auth = betterAuth({
  trustedOrigins: ["http://localhost:3000", "https://benefit-finance.vercel.app", "https://total-recall-ai-git-cc-remis-projects-738a757c.vercel.app"],

  database: drizzleAdapter(db, {
    provider: "pg",
    schema: { user: UserTable, session: SessionTable, account: AccountTable, verification: VerificationTable },
  }),
  appName: "benefit-finance",
