  ...
  return (
    <motion.section className="clear-both" initial="hidden" whileInView="visible" variants={LIST} viewport={{ once: true }}>
      ...
      <motion.p variants={ITEM}>
        {
          ll[
            "If you are planning an investment and want to check whether you can benefit from funding from the European Union or government programs, please contact us."
          ]
        }
      </motion.p>
      <br />
      <motion.p variants={ITEM}>{ll["The first conversation is non-binding."]}</motion.p>
      <br />
      <motion.p variants={ITEM}>{ll["Check funding opportunities."]}</motion.p>
    </motion.section>
  );
}
