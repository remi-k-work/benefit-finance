...
interface ProperlySelectedProps {
...
export function ProperlySelected({ ll }: ProperlySelectedProps) {
  return (
    <motion.section className="clear-both" initial="hidden" whileInView="visible" variants={LIST} viewport={{ once: true }}>
      <SectionHeader title={ll["Properly selected funding allows"]} />
