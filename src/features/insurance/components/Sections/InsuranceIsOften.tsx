...
interface InsuranceIsOftenProps {
...
export function InsuranceIsOften({ ll }: InsuranceIsOftenProps) {
  return (
    <motion.section className="float-end" initial="hidden" whileInView="visible" variants={LIST} viewport={{ once: true }}>
      <SectionHeader title={ll["Insurance is often treated as an additional expense. In practice, it is a part of financial planning that"]} />
      <motion.p className="flex items-center gap-6" variants={ITEM}>
        ...
        {ll["It protects the achievements built over the years."]}
      </motion.p>
      <br />
      <motion.p className="flex items-center gap-6" variants={ITEM}>
        <span className="bg-primary animate-bullet-blink inline-block size-6 shrink-0 delay-3000" />
        {ll["Protects family and loved ones."]}
      </motion.p>
      <br />
      <motion.p className="flex items-center gap-6" variants={ITEM}>
        <span className="bg-primary animate-bullet-blink inline-block size-6 shrink-0 delay-6000" />
        {ll["It allows the company to survive difficult times."]}
      </motion.p>
      <br />
      <motion.p className="flex items-center gap-6" variants={ITEM}>
        <span className="bg-primary animate-bullet-blink inline-block size-6 shrink-0 delay-9000" />
        {ll["Reduces the need to take out a loan in emergency situations."]}
      </motion.p>
      <br />
      <motion.p className="flex items-center gap-6" variants={ITEM}>
        <span className="bg-primary animate-bullet-blink inline-block size-6 shrink-0 delay-12000" />
        {ll["A conscious choice of insurance is a decision about continuity and peace of mind, not about the product itself."]}
      </motion.p>
    </motion.section>
  );
}

export function InsuranceIsOftenSkeleton() {
  return (
