...
import { useFormToastFeedback, usePermanentMessageFeedbackLoc } from "@/hooks/feedbacks";
...
export function useVerifyEmailFeedback(
  ...
  const showToast = useFormToastFeedback(
    ll["[VERIFY EMAIL]"],
    { succeeded: ll["A verification email has been sent to your current email address. Please check your inbox."] },
    llFormToastFeedback,
  );
