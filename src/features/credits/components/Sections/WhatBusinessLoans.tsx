...
interface WhatBusinessLoansProps {
...
export function WhatBusinessLoans({ ll }: WhatBusinessLoansProps) {
  return (
    <motion.section className="float-end" initial="hidden" whileInView="visible" variants={LIST} viewport={{ once: true }}>
      <SectionHeader title={ll["What kind of business loans do we help you get?"]} />
      <motion.p className="flex items-center gap-6" variants={ITEM}>
        ...
        {ll["Business loan for any purpose."]}
      </motion.p>
      <br />
      <motion.p className="flex items-center gap-6" variants={ITEM}>
