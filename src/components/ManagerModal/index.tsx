...
interface ManagerModalProps extends ComponentPropsWithoutRef<"dialog"> {
  icon: ReactNode;
  title: string;
  children: ReactNode;
}
...
export default function ManagerModal({ icon, title, children, className, ...props }: ManagerModalProps) {
